...
$info_url='blabax.php'; $info_line=$lang['wrong_pass'];
require_once('templates/info.pxtm'); die();}
...
$info_url='blabax.php'; $info_line=$lang['wrong_recansw'];
require_once('templates/info.pxtm'); die();}
